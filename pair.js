...
const BOT_NAME_FANCY = config.BOT_NAME || "BLACK QUEEN MD";
            ...
            if (connection === 'close') {
                ...
                if (!global.isBotActiveSent) {
                    try {
                        ...
                        const activeText = `╭━━━〔 *BLACK QUEEN MD* 〕━━━┈⊷\n┃ 🐉 *ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ !*\n╰━━━━━━━━━━━━━━━┈⊷\n\n**\n\n_🫟 BLACK QUEEN MD ɪs ɴᴏᴡ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ʀᴇᴀᴅʏ ᴛᴏ ᴜsᴇ!_`;
                        await sock.sendMessage(jid, { image: { url: "https://h.uguu.se/bTvBgcRb.jpg" }, caption: activeText });
        ...
        sock.ev.on('messages.upsert', async (mek) => {
            try {
                ...
                if (sessionConfig.AUTO_BIO === 'true' || sessionConfig.AUTO_BIO === true) {
                    ...
                    await sock.updateProfileStatus(`*Ｂʟᴋ Ｑᴜᴇᴇɴ ᴍᴅ v1 Cᴏɴɴᴇᴄᴛ Sᴜᴄᴄᴇꜱꜱꜰᴜʟ 🚀..."* *${currentUptime}* `).catch(() => {});
                }
